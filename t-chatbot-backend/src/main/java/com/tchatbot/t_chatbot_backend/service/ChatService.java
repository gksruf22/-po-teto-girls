...
public class ChatService {
    ...
    public String getTChatResponse(String userMessage, String mode) {
        String systemPrompt = getSystemPrompt(mode, userMessage);
    ...
    public String getTChatResponse(String userMessage) {
        return getTChatResponse(userMessage, "default");
    }

    private String getSystemPrompt(String mode, String userMessage) {
        if (mode == null) {
            mode = "default";
        }
        ...
        switch (mode) {
            case "love":
                return getLovePrompt(userMessage);
            case "tbrainwash":
                return getTBrainwashPrompt(userMessage);
            case "default":
            default:
                return getDefaultPrompt(userMessage);
        }
    }
